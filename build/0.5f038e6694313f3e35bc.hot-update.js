	...
	/* REACT HOT LOADER */if (true) {
	  ...
	  (function () {
	    ...
	    var App = function App(_ref) {
	      ...
	      return _react2.default.createElement('div', null, _react2.default.createElement('ul', { 'class': 'nav navbar-nav' }, _react2.default.createElement('a', null, _react2.default.createElement(_reactRouter.Link, { to: '/hello' }, 'Hello')), _react2.default.createElement(_reactRouter.Link, { to: '/updateText' }, 'Update Text')), _react2.default.createElement(_reactAddonsCssTransitionGroup2.default, {
